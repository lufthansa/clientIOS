...
--游戏空闲
cmd.SUB_S_GAME_FREE				= 919
--游戏开始
cmd.SUB_S_GAME_START			= 150
--用户下注
cmd.SUB_S_PLACE_JETTON			= 701
--游戏结束
cmd.SUB_S_GAME_END				= 102
--申请庄家
cmd.SUB_S_APPLY_BANKER			= 103
--切换庄家
cmd.SUB_S_CHANGE_BANKER			= 267
--更新积分
cmd.SUB_S_CHANGE_USER_SCORE		= 565
--游戏记录
cmd.SUB_S_SEND_RECORD			= 166
--下注失败
cmd.SUB_S_PLACE_JETTON_FAIL		= 607
--取消申请
cmd.SUB_S_CANCEL_BANKER			= 167
--检查图
cmd.SUB_S_CHECK_IMAGE			= 129

--管理员命令
cmd.SUB_S_ADMIN_COMMDN			= 180
--更新库存
cmd.SUB_S_NOTICE_TIME		= 161
...
--用户下注
cmd.SUB_C_PLACE_JETTON				= 131
--申请庄家
cmd.SUB_C_APPLY_BANKER				= 167
--取消申请
cmd.SUB_C_CANCEL_BANKER				= 63
--继续发牌
cmd.SUB_C_CONTINUE_CARD				= 89
--
cmd.SUB_C_CHECK_IMAGE			= 55
--系统控制
cmd.SUB_C_ADMIN_COMMDN           = 176
