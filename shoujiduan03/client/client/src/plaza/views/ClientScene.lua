...
function ClientScene:onCreate()
	...
	if PriRoom then
		print("willche int ClientScene:onCreate has priroom " );
	else
		print("willche int ClientScene:onCreate no priroom " );
	end
...
function ClientScene:getTagLayer(tag, param)
	print(" int ClientScene:getTagLayer tag = " .. tag);
	local dst
...
function ClientScene:setButVisible( bool )
	if not self.vbut then
		return
	end
	self.vbut:setVisible(bool)
end
